 ...
 * numbers behind it (real, verified: ~4.4 rating, ~149 reviews, per
 * CLAUDE.md). Same facts, no new/invented numbers, just real visual weight:
 * large numerals + a star row instead of small caption text.
 */
